...
<div class="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700 shadow-xl rounded-xl">
    <div class="flex items-center gap-3 mb-8">
        <a href="{{ route('notes.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400" title="Voltar">
        ...
        <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100">Nova anotação</h1>
    </div>

    <form action="{{ route('notes.store') }}" method="POST">
        @include('notes._form', ['submitLabel' => 'Criar anotação'])
    </form>
</div>
@endsection
